...
//        $errors['image'] = "Image Must Be Png Image";
//   }
...
//        $_FILES
//        [
//           'image'=>['name'=>'omar.png' , 'type'=>'pdf' , 'size'=>'3333333', 'tmp_name'=>'dsdsds']
//       ]

    
    
        $query = "INSERT into product (id,name,details,status,created_at,first_price,price,category_id,qty)
        VALUES ('$id','$name', '$details', '$active', '$data', '$first_price', '$price', '$category_id', '$qty')";
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" id="first_price"
                                                                   class="form-control"
                                                                   placeholder="first_price of Product"
                                                                   name="first_price">
                                                            <span class="text-danger errors">
                                                                <?php
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group mt-1 col-lg-3">
                                                        ...
                                                        <label for="switcheryColor4"
                                                               class="card-title ml-2  mr-2">الحالة
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
