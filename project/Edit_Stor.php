       ...
       $Category=$_POST['S-Category'];
        ...
        if (count($errors) >0){
            $errors['general_error']="Please Fix All Error";
                ...
                $query="UPDATE stores set name='$name',description='$description',
              categoryName=' $Category',Adress='$Adress',phone='$phone' where id ='".$_GET['id']."'";
                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <form class="form" method="post" enctype="multipart/form-data"  action="<?php echo $_SERVER['PHP_SELF'] . "?id=$id"?>">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="projectinput1" class="form-control" placeholder="Stror Name"
                                                               name="S-name"  value="<?php echo $row['name']?>">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="projectinput1" class="form-control" placeholder="Category Name"
                                                               name="S-Category"  value="<?php echo $row['categoryName']?>">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" id="projectinput1" class="form-control" placeholder="Stror phone"
                                                               name="S-phone"  value="<?php echo $row['phone']?>">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="projectinput2" class="form-control" placeholder="Stror Description"
                                                               name="S-description"  value="<?php echo $row['description']?>">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="projectinput2" class="form-control" placeholder="Stror Adress"
                                                               name="S-Adress" value="<?php echo $row['Adress']?>">
                                                ...
                                                <div class="col-md-6">
													<div class="form-group">
														...
														<input type="file" id="projectinput3" class="form-control"  name="image[]"  value="<?php echo $row['Image']?>">
